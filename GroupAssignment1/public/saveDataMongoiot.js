...
function saveData(event){	
				...
				window.open("http://www.oracle.com/us/solutions/machine-to-machine/m2m-brochure-1951397.pdf");
                var httpRequest;
var form = document.getElementById("regis");
			...
			function saveData1(event){	
				...
				window.open("http://www.freescale.com/files/32bit/doc/white_paper/INTOTHNGSWP.pdf");
                var httpRequest;
